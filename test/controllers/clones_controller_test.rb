...
class ClonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clone" do
    assert_difference("Clone.count") do
      post clones_url, params: { clone: { description: @clone.description, username: @clone.username } }
    end
  ...
  test "should update clone" do
    patch clone_url(@clone), params: { clone: { description: @clone.description, username: @clone.username } }
